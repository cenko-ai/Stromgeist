    ...
    <ArticleLayout>
      ...
      <div className="article-content">
        ...
        <div className="article-links">
          ...
          <a href="https://tibber.com/de" target="_blank" rel="noopener noreferrer">Tibber (dynamisch)</a>
        </div>
        ...
        <div className="author-box">
          ...
          <div>
            ...
            <p>Ich arbeite als Portfoliomanager Strom & Gas und beobachte Energiemärkte täglich. Dieser Beitrag repräsentiert meine persönliche Sichtweise ohne versteckte Interessen.</p>
          </div>
        </div>
      </div>
    </ArticleLayout>
