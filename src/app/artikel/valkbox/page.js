...
export const metadata = {
  ...
  description: 'Wie ich meine Solarmodule mit der Valkbox 3 auf dem Garagendach befestigt habe — ohne Bohren, ohne Handwerker.',
};

export default function Article() {
  return (
    <ArticleLayout
      title="Balkonkraftwerk auf dem Flachdach — wie ich meine Module mit der Valkbox 3 befestigt habe"
      byline="Von Stromgeist · März 2026 · 6 Minuten Lesezeit · Praxisbericht"
    >
      ...
      <div className="article-links">
        ...
        <a href="https://amzn.to/4brI9NB" target="_blank" rel="noopener">Valkbox 3 Flachdach-Aufständerung ↗</a>
      </div>
