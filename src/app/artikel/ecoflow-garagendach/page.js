...
export const metadata = {
  title: 'Mein Garagendach erzeugt Strom — wie EcoFlow mein Zuhause teilweise autark macht | Stromgeist',
  description: 'Praxisbericht: Solarmodule auf dem Garagendach, drei EcoFlow-Speicher und ein EcoFlow Smart Meter. Was ich gelernt habe.',
};
...
export default function Article() {
  return (
    <ArticleLayout
      ...
      byline="Von Stromgeist · März 2026 · 8 Minuten Lesezeit · Praxisbericht"
    >
      ...
      <div className="article-links">
        ...
        <a href="https://amzn.to/4uODI76" target="_blank" rel="noopener">EcoFlow STREAM Ultra ↗</a>
        <a href="https://amzn.to/3Njzbc1" target="_blank" rel="noopener">EcoFlow STREAM Max ↗</a>
        <a href="https://amzn.to/4lPzb0a" target="_blank" rel="noopener">EcoFlow AC Pro ↗</a>
        <a href="https://amzn.to/41pMxXe" target="_blank" rel="noopener">EcoFlow Smart Meter ↗</a>
      </div>
