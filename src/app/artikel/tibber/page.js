...
export const metadata = {
  ...
  description: "Erfahre ob dynamische Tarife wie Tibber für dich Sinn machen und wie viel du sparen kannst.",
};

export default function ArticleTibber() {
  return (
    <ArticleLayout>
      <h1>Dynamische Stromtarife — für wen lohnt sich Tibber wirklich?</h1>
      ...
      <div className="article-content">
        ...
        <div className="article-links">
          <h4>Mehr erfahren</h4>
          <a href="https://tibber.com/de" target="_blank" rel="noopener noreferrer">Tibber</a>
          <a href="https://www.ostrom.de" target="_blank" rel="noopener noreferrer">Ostrom (Alternative)</a>
          <a href="https://partner.verivox.de/go.cgi?pid=6744&wmid=37&cpid=1&prid=93&subid=&target=stromvergleich_2019-09" target="_blank" rel="noopener noreferrer">Alle Tarife vergleichen</a>
        </div>
